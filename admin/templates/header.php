...
<head>
  ...
  <title>SI-PEKERBA KAB. GOWA</title>
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/pemkab-gowa-logo.png" alt="SI-PEKERBA" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">SI-PEKERBA GOWA</span>
    </a>
