...
<head>
    ...
    <title>Login | SI-PEKERBA KAB. GOWA</title>
    <!-- icon pemkab-gowa -->
    <link rel="icon" href="../assets/dist/img/pemkab-gowa-logo.png">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6">
                ...
                <img src="css/pemkab-gowa-logo.png" width="40" height="40">
                <p class="lead">Kabupaten Gowa</p>
                ...
                <br><center><p>Copyright &copy; 2024 Semua Hak Dilindungi | Dibuat dengan oleh <a href='#' title='aryaclouddatabase@gmail.com' target='_blank'>Muhammad Arya Ananda S</a></p></center>
